...
"CI":http://travis-ci.org/#!/rubygems/gemcutter !https://secure.travis-ci.org/rubygems/gemcutter.png?branch=master!
...
Our deployment process is documented on the wiki as well, there's a multi-step "Checklist":https://github.com/rubygems/gemcutter/wiki/Deployment to run through.
