...
class ButtonComponent < ApplicationComponent
  ...
  attr_reader :text, :href, :type, :options, :color, :size, :outline
  ...
  def view_template(&block)
    css = "text-nowrap font-semibold no-underline " \
          ...
          "#{button_color(color, outline)} #{button_size(size)} #{options.delete(:class)}"
  ...
  def button_color(color, outline)
    ...
    outline ? OUTLINE_BUTTON_COLOR[color] : FILL_BUTTON_COLOR[color]
  end
  ...
  OUTLINE_BUTTON_COLOR = {
    orange:    "border-2 border-orange-500 text-orange-500 " \
               ...
               "dark:hover:border-orange-700 dark:hover:text-orange-700 " \
               "dark:active:border-orange-700 dark:active:text-orange-700",
    ...
    neutral:   "border-2 border-neutral-700 text-neutral-700 " \
               "hover:border-neutral-600 hover:text-neutral-600 " \
               "active:border-neutral-600 active:text-neutral-600 " \
               "dark:hover:border-neutral-700 dark:hover:text-neutral-700 " \
               "dark:active:border-neutral-700 dark:active:text-neutral-700"
  }.freeze
