  ...
  def view_template
    ...
    div(class: "") do
      ...
      div(class: "t-body") do
        ...
        div(class: "") do
          api_key_roles_pagy, api_key_roles = Pagy::Backend.pagy(current_user.oidc_api_key_roles.where(provider:), page: 0, items: 10)
          header(class: "gems__header push--s") do
            p(class: "gems__meter l-mb-0") { plain helpers.pagy_info(api_key_roles_pagy) }
          end
