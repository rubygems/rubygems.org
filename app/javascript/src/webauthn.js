...
(function() {
  ...
  onReady(() => {
    const credentialForm = document.querySelector(".js-new-webauthn-credential--form");
    if (!credentialForm) { return; }
    const credentialError = document.querySelector(".js-new-webauthn-credential--error");
    const credentialSubmit = document.querySelector(".js-new-webauthn-credential--submit");
    ...
    credentialForm.addEventListener("submit", function(event) {
      ...
      const nicknameInput = document.querySelector(".js-new-webauthn-credential--nickname");
  ...
  onReady(() => {
    const cliSessionForm = document.querySelector(".js-webauthn-session-cli--form");
    if (!cliSessionForm) { return; }
    const cliSessionError = document.querySelector(".js-webauthn-session-cli--error");
    const csrfMeta = document.querySelector("[name='csrf-token']");
    const csrfToken = csrfMeta ? csrfMeta.getAttribute("content") : "";
  ...
  onReady(() => {
    ...
    const sessionSubmit = document.querySelector(".js-webauthn-session--submit");
