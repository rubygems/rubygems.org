...
class AddBlockedEmailTrigramIndexForAvoUserSearch < ActiveRecord::Migration[8.1]
  INDEX_NAME = "index_users_on_blocked_email_trigram"

  disable_ddl_transaction!

  def up
    remove_invalid_index
    return if index_exists?(:users, :blocked_email, name: INDEX_NAME)
