...
module Gemcutter
  class Application < Rails::Application
    ...
    require_relative '../lib/gemcutter/middleware/security_headers'
    config.middleware.insert 0, ::Gemcutter::Middleware::SecurityHeaders

    config.middleware.insert 1, Rack::Sanitizer
