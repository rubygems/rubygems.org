Rails.application.routes.draw do
  ...
  scope constraints: { format: :html }, defaults: { format: 'html' } do
    ...
    resources :rubygems,
      ...
      delete "transfer", to: "rubygems/transfer#destroy"
      ...
      namespace :transfer do
        ...
        get "confirm", to: "/rubygems/transfer/confirm#edit"
        patch "confirm", to: "/rubygems/transfer/confirm#update"
      end
    end
    ...
    resources :organizations, only: %i[index show edit update], constraints: { id: Patterns::ROUTE_PATTERN } do
      ...
      resources :memberships, controller: 'organizations/members'
      resource :invitation, only: %i[show update], constraints: { id: Patterns::ROUTE_PATTERN }, controller: 'organizations/invitation'
    end
  end
