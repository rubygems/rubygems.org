...
Rails.application.routes.draw do
  ...
  get "/#{LocaleRouting::DEFAULT_LOCALE}", to: redirect(&LocaleRouting.strip_default_locale_redirect)
  get "/#{LocaleRouting::DEFAULT_LOCALE}/*path", to: redirect(&LocaleRouting.strip_default_locale_redirect)
  ...
  scope "(:locale)", locale: LocaleRouting::PATH_CONSTRAINT do
    ...
    get 'pages/sponsors',
      to: redirect(&LocaleRouting.localized_redirect("/pages/supporters")),
