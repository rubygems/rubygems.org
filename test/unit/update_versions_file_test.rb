...
class UpdateVersionsFileTest < ActiveSupport::TestCase
  ...
  should "delegate the default compact index versions file task to v2" do
    ...
    create(:version, rubygem:, number: "1.0.0", created_at: 1.minute.ago, info_checksum_v2: "v2_checksum")
  ...
  should "use yanked_info_checksum_v2 for yanked versions" do
    ...
    rubygem = create(:rubygem, name: "foo")
    create(:version, rubygem:, number: "1.0.0", created_at: 2.minutes.ago, info_checksum_v2: "v2_checksum")
    create(:version,
      :yanked,
      rubygem:,
      number: "1.0.1",
