  ...
  test "multipart" do
    ...
    post api_v1_rubygems_path,
         params: { "gem" => Rack::Test::UploadedFile.new(gem_file("sigstore-1.0.0.gem"), "application/octet-stream"),
                   "sigstore.json" => Rack::Test::UploadedFile.new(gem_file("sigstore-1.0.0.gem.sigstore.json"), "application/json") },
    ...
    assert_response :success
    assert_equal File.read(gem_file("sigstore-1.0.0.gem.sigstore.json")),
                 RubygemFs.instance.get("sigstore/sigstore-1.0.0.gem.sigstore.jsonl")
  end
