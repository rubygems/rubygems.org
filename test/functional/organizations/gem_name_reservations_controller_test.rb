...
class Organizations::GemNameReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "GET /organizations/:organization_handle/reservations" do
    ...
    get organization_gem_name_reservations_path(organization_id: @organization)
  ...
  test "GET /organizations/:organization_handle/reservations for an unknown organization" do
    get organization_gem_name_reservations_path(organization_id: "not-an-organization")
  ...
  test "GET /organizations/:organization_handle/reservations paginates after 50" do
    ...
    get organization_gem_name_reservations_path(organization_id: @organization, page: 2)
  ...
  test "GET /organizations/:organization_handle/reservations/new" do
    get new_organization_gem_name_reservation_path(organization_id: @organization)
  ...
  test "POST /organizations/:organization_handle/reservations" do
    post organization_gem_name_reservations_path(organization_id: @organization), params: { gem_name_reservation: { name: "sandworm" } }

    assert_redirected_to organization_gem_name_reservations_path(organization_id: @organization)
  ...
  test "DELETE /organizations/:organization_handle/reservations/:id" do
    ...
    delete organization_gem_name_reservation_path(organization_id: @organization, id: reservation)
