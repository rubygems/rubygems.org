...
class SearchTest < ApplicationSystemTestCase
  ...
  test "searching for a yanked gem" do
    ...
    click_link "Yanked (1)" # Using "YANKED (1)" will not work in Capybara

    assert_text "LDAP"
    assert_selector "a[href='#{rubygem_path('LDAP')}']"
  end
  ...
  test "params has non white listed keys" do
    ...
    assert has_link?("Next", href: "/search?page=2&query=ruby")
  ...
  test "searching for reverse dependencies" do
    ...
    refute_text "Search reverse dependencies Gems…"
